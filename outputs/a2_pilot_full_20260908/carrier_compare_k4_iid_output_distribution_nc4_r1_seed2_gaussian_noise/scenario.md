...
- Scenario: `{'tag': 'carrier_compare', 'seed': 2, 'corruption': 'gaussian_noise', 'severity': 5, 'split_type': 'iid', 'client_count': 4, 'rounds': 1, 'n_c': 4, 'carrier': 'output_distribution'}`
- Split type: `iid`
...
## Message Leakage
- NoRaw payload-only member AUC: 0.5273
- NoRaw full-transcript member AUC: 0.4420
