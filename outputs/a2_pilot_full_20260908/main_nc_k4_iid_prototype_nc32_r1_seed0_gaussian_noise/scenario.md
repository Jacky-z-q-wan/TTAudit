...
- Scenario: `{'tag': 'main_nc', 'seed': 0, 'corruption': 'gaussian_noise', 'severity': 5, 'split_type': 'iid', 'client_count': 4, 'rounds': 1, 'n_c': 32, 'carrier': 'prototype'}`
- Split type: `iid`
- Carrier: `prototype`
- Clients: `4`
- Rounds: `1`
...
## Message Leakage
- NoRaw payload-only member AUC: 0.4467
- NoRaw full-transcript member AUC: 0.4626
