...
- Scenario: `{'tag': 'carrier_compare', 'seed': 1, 'corruption': 'gaussian_noise', 'severity': 5, 'split_type': 'iid', 'client_count': 4, 'rounds': 1, 'n_c': 4, 'carrier': 'bn_stats'}`
- Split type: `iid`
- Carrier: `bn_stats`
- Clients: `4`
- Rounds: `1`
...
## Message Leakage
- NoRaw payload-only member AUC: 0.3995
- NoRaw full-transcript member AUC: 0.4703
