...
- Scenario: `{'tag': 'distribution_fingerprint', 'seed': 2, 'corruption': 'gaussian_noise', 'severity': 5, 'split_type': 'label_skew', 'client_count': 4, 'rounds': 1, 'class_cap': 16, 'carrier': 'prototype', 'n_c': 16}`
...
- NoRaw payload-only class presence BA: 0.7083
